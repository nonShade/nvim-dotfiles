return {
    ...
    config = function()
        ...
        telescope.setup({
            ...
            extensions = {
                themes = {
                    ...
                    persist = {
                        enabled = true,
                        path = vim.fn.stdpath("config") .. "/lua/plugins/colorscheme.lua", -- updated path
                    },
                },
            },
        })
        ...
        -- NOTE: set keymaps
        vim.keymap.set("n", "<leader><Space>", "<cmd>Telescope find_files<CR>", { desc = "Fuzzy find files in cwd" })
        vim.keymap.set("n", "<leader>pr", "<cmd>Telescope oldfiles<CR>", { desc = "Fuzzy find recent files" })
        vim.keymap.set("n", "<leader>fp", "<cmd>Telescope live_grep<CR>", { desc = "Fuzzy search string in cwd" })
